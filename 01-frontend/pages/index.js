//components
import FeaturesGradient from '../src/components/website/featuresGradient';
import HeroImage from '../src/components/website/heroImage';
  ...
  return (
    <div className="bg-white">
        ...
        <Popover className="relative bg-gray-900">
          <div className="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        ...
                        'group bg-gray-900 rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                      )}
                    >
                      <span>Solutions</span>
                      <ChevronDownIcon
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              ...
              <a
                href="#"
                className="ml-8 whitespace-nowrap inline-flex items-center justify-center bg-button px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white"
              >
                Sign up
              </a>
            </div>
      ...
      <main>
        ...
        <HeroImage 
          headline="Neptune CS" 
          subheadline="No code game maker." 
          intro="Intro text and more." 
          image="https://tailwindui.com/img/component-images/cloud-illustration-indigo-400.svg"
        />
        ...
        <FeaturesGradient 
          headline="Inbox support built for efficiency" 
          intro="Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis. Blandit
